...
const Header3 = () => {
  return (
    <div className=" bg-gradient-to-r from-green-600 to-green-400 h-60">
      <div className=" p-5">
        ...
        <div className="flex justify-center my-5 mx-20 ">
          ...
          <button
            type="submit"
            className=" h-16 px-3 py-2 w-72 bg-yellow-400 hover:cursor-pointer hover:bg-blue-600 text-white text-xl"
          >
             Search
          </button>
        </div>
